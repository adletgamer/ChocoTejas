    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="container mx-auto px-4 z-10 text-center max-w-4xl">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 text-foreground">
          Chocotejas <span className="bg-gradient-primary bg-clip-text text-transparent">Artesanales</span>
        </h1>
        <p className="text-xl md:text-2xl mb-8 text-muted-foreground max-w-2xl mx-auto">
          Personaliza tu regalo perfecto con nuestros sabores únicos y un mensaje especial
        </p>
        <Button 
          size="lg" 
